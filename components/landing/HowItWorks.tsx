    ...
    <section id="how-it-works" className="relative py-36 overflow-hidden" style={{ background: "#070B14" }}>
      <div className="relative z-10 max-w-6xl mx-auto px-5">
                ...
                <div className="w-full p-px rounded-3xl" style={{ background: "linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(59,130,246,0.12) 100%)" }}>
                  <div className="glass-shimmer relative rounded-[23px] overflow-hidden backdrop-blur-xl" style={{ background: "rgba(13,18,32,0.6)" }}>
                    ...
                    <div className="px-5 pt-5 pb-4 flex justify-end border-b border-white/[0.04]">
                      <div className="max-w-[80%] backdrop-blur-sm bg-white/[0.05] border border-white/[0.07] rounded-2xl rounded-br-sm px-4 py-2.5 text-[13px] text-white/55">
                        {step.q}
                      </div>
                    </div>
                    {/* BL answer */}
                    <div className="px-5 py-5 flex gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex gap-2">
                          {step.sources.map(s => (
                            <span key={s} className="px-2.5 py-1 rounded-full border border-accent/15 text-[11px] text-accent/40">
                              {s}
                            </span>
                          ))}
                        </div>
        ...
        <motion.div
          ...
          className="mt-12 pt-10 border-t border-white/[0.05]"
        >
          <a
